...
public class Certona_14Cart_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\14Cart_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\14Cart_Teacher_Expected.txt";
