...
public class Certona_9Search_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\9Search_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\9Search_Teacher_Expected.txt";
