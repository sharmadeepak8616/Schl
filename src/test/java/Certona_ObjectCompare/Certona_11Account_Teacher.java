...
public class Certona_11Account_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\11Account_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\11Account_Teacher_Expected.txt";
