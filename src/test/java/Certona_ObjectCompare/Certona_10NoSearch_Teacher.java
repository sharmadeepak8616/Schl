...
public class Certona_10NoSearch_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\10NoSearch_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\10NoSearch_Teacher_Expected.txt";
