...
public class Certona_13Wishlist_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\13Wishlist_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\13Wishlist_Teacher_Expected.txt";
