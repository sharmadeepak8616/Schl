...
public class Certona_15Emptycart_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\15Emptycart_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\15Emptycart_Teacher_Expected.txt";
