...
public class Certona_12Product_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\12Product_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\12Product_Teacher_Expected.txt";
