...
public class Certona_16Confirmation_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\16Confirmation_Teacher_Actual.txt";
        //String pathActualFile = "C:\\Schl\\CertonaFiles\\16Confirmation_Teacher_Actual_2.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\16Confirmation_Teacher_Expected.txt";
