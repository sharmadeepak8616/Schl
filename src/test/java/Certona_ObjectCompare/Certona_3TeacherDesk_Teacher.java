...
public class Certona_3TeacherDesk_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\3TeacherDesk_Teacher_Actual.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\3TeacherDesk_Teacher_Expected.txt";
