...
public class Certona_5TeacherOrder_Teacher {

    public static void main(String[] args) throws Exception {

        String pathActualFile = "C:\\Schl\\CertonaFiles\\5TeacherOrder_Teacher_Actual_1YTO.txt";
        String pathExpFile = "C:\\Schl\\CertonaFiles\\5TeacherOrder_Teacher_Expected.txt";
